 ...
 *  Apache Software Foundation (ASF) - initial implementation
 */
 ...
 *
 */
public final class KarafLaunchConfigurationUtils {

    /**
     * Disallow instantiation
     */
    private KarafLaunchConfigurationUtils() {
    }
    ...
    public static void interpolateVariables(final Properties configProperties,
        ...
        for (Enumeration e = configProperties.propertyNames(); e
            ...
            final String newValue = substVars(value, name, null,
                    initialProperties);
