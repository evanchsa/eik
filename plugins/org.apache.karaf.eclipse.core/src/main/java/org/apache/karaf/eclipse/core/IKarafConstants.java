...
public interface IKarafConstants {
    ...
    public static final String KARAF_DEFAULT_PLATFORM_PROVIDER_SYMBOLIC_NAME = "org.apache.karaf.eclipse.target"; //$NON-NLS-1$
    ...
    public static final String KARAF_OSGI_FRAMEWORK_ID = "org.apache.karaf.eclipse.Framework"; //$NON-NLS-1$
