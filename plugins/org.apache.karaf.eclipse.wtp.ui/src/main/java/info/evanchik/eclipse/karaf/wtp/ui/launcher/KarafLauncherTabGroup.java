 ...
 *
 */
package org.apache.karaf.eclipse.wtp.ui.launcher;

import org.apache.karaf.eclipse.ui.KarafConfigurationTab;
...
public class KarafLauncherTabGroup extends AbstractLaunchConfigurationTabGroup {
    ...
    public void createTabs(final ILaunchConfigurationDialog dialog, final String mode) {
        final ILaunchConfigurationTab[] tabs = new ILaunchConfigurationTab[] {
                new ServerLaunchConfigurationTab(new String[] { "org.apache.karaf.eclipse.server" }),  //$NON-NLS-1$
