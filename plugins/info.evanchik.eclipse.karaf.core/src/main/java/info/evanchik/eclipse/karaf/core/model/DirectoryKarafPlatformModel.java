 ...
 *
 */
public class DirectoryKarafPlatformModel extends AbstractKarafPlatformModel {
    ...
    private final KarafPlatformValidatorStrategy defaultKarafPlatformValidator;

    public DirectoryKarafPlatformModel(IPath platformPath) {
        this.rootPlatformPath = platformPath;

        defaultKarafPlatformValidator = new GenericKarafPlatformValidator(platformPath);
    }
    ...
    public boolean isValid() {
        return defaultKarafPlatformValidator.isValid();
    }
